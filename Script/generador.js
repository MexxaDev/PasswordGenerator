...
boton.onclick = function(){
    ...
    let CarX2 = Math.floor(Math.random()*(8-0))+0;
    ...
    VenetanaGenerador.innerHTML = Lmay[letraMay2]+  numeros[num1]  + Lmin[letraMin] + numeros[num2] + Lmay[letraMay] + car[Car] + carX[CarX] + carX[CarX2] ;
}
